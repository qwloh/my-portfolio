...
const Svg = (props) => {
  ...
  switch(props.name){
    case 'expand':
      ...
      break;
    case 'bg-square-m':
      icon = <path fill-rule="evenodd" clip-rule="evenodd" d="M5 0C2.23859 0 0 2.23859 0 5V25C0 27.7614 2.23859 30 5 30H25C27.7614 30 30 27.7614 30 25V5C30 2.23859 27.7614 0 25 0H5ZM5 3C3.89545 3 3 3.89545 3 5V25C3 26.1046 3.89545 27 5 27H25C26.1046 27 27 26.1046 27 25V5C27 3.89545 26.1046 3 25 3H5Z"/>;
      break;
    default:
      break;
  }
